...
export default function LoginPage() {
  ...
  const personas: {
    ...
    {
      role: 'branch_officer',
      title: 'เจ้าหน้าที่สาขา (Branch Officer)',
      desc: 'ยื่นใบสมัครใหม่, อัปโหลดเอกสาร, แก้ไขใบสมัคร',
      department: 'สาขา / ฝ่ายขาย',
      icon: <Users className="w-5 h-5 text-primary" />,
      color: 'border-blue-200 hover:border-primary hover:bg-blue-50/50',
    },
    {
      role: 'ho_reviewer',
      title: 'เจ้าหน้าที่ตรวจรับ สนญ. (HO Reviewer)',
      desc: 'ตรวจเอกสารครบถ้วน, รันตรวจ AMLO / คปภ. Sanctions',
      department: 'สำนักงานใหญ่ (HQ)',
      icon: <ShieldCheck className="w-5 h-5 text-indigo-700" />,
      color: 'border-indigo-200 hover:border-indigo-600 hover:bg-indigo-50/50',
    },
    {
      role: 'approver_md',
      title: 'กรรมการผู้จัดการ (MD Approver)',
      desc: 'พิจารณาอนุมัติใบสมัครในระบบ พร้อมระบบแจ้งเตือนอีเมล',
    ...
    },
    {
      ...
      title: 'ฝ่ายสินเชื่อ & รหัสตัวแทน (Premium Reviewer)',
      desc: 'กำหนดวงเงิน, สร้าง Agent Code และยิงเชื่อมต่อ 4 Core Systems',
      department: 'ฝ่ายสินเชื่อและการเงิน',
      icon: <Award className="w-5 h-5 text-teal-700" />,
      color: 'border-teal-200 hover:border-teal-600 hover:bg-teal-50/50',
    },
    {
      role: 'auditor_legal',
      title: 'ฝ่ายกฎหมาย & สัญญา (Legal Auditor)',
      desc: 'ตรวจรับสัญญาตัวจริง, ลงทะเบียนกล่อง, ปลดล็อกถาวร',
      department: 'ฝ่ายกฎหมาย',
      icon: <FileSpreadsheet className="w-5 h-5 text-green-700" />,
      color: 'border-green-200 hover:border-green-600 hover:bg-green-50/50',
    },
    {
      role: 'admin',
      title: 'ผู้ดูแลระบบ (System Admin)',
      desc: 'ควบคุมสิทธิ์ เข้าถึงทุกเมนู และติดตาม SLA Daemon',
