...
export const Sidebar: React.FC = () => {
  ...
  const navigationItems = [
    ...
    {
      label: 'สนญ. ตรวจรับ & ตรวจ ปปง./คปภ.',
      href: '/review',
      icon: <ClipboardCheck className="w-5 h-5" />,
      show: canReviewCompliance,
    },
    {
      label: 'ผู้บริหารพิจารณาอนุมัติ',
      href: '/approval',
      icon: <CheckCircle2 className="w-5 h-5" />,
      show: canApproveExecutive,
    },
    {
      label: 'ฝ่ายบริหารเบี้ย & เปิดรหัสระบบ',
      href: '/provisioning',
      icon: <Server className="w-5 h-5" />,
      show: canProvisionCore,
    },
    {
      label: 'ฝ่ายกฎหมาย จัดเก็บสัญญา',
      href: '/archive',
      icon: <Archive className="w-5 h-5" />,
      show: canArchiveLegal,
    },
    {
      label: 'ติดตามกำหนดส่งสัญญา (30 วัน)',
      href: '/sla-dashboard',
